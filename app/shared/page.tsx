...
// SIMPLIFIED: Only exists and revoked
interface VerificationResult {
  exists: boolean; // Does NFT exist on blockchain?
  revoked: boolean; // Is it revoked?
...
export default function SharedPage() {
  ...
  // SIMPLIFIED: Copy report with only exists/revoked
          ...
          {certificates.map((cert) => (
            <div key={cert.nftAddress} className="relative">
              ...
              <div className="relative">
                <CertificateCard
                  certificate={{
                    ...
                    student: {
                      ...
                      walletAddress: cert.recipientWallet,
                    },
                ...
                {/* SIMPLIFIED: Verification Details - Only exists/revoked */}
